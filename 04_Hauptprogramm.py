...
class LucasKanadeTracker:
    def __init__(self):
        ...
        self.distance_threshold = 150  # Maximale Distanz für das Clustering
        self.clusters = {}  # Aktive Cluster
        self.next_id = 1  # ID für den nächsten neuen Cluster
        self.max_missing_frames = 90  # Frames ohne Aktualisierung bevor ein Cluster entfernt wird
        self.still_threshold = 0.9  # Bewegungsschwelle für das Tracking
        self.alpha = 0.2  # Glättungsfaktor für die Bounding Box
        self.min_points_per_cluster = 8  # Mindestanzahl von Punkten pro Cluster
